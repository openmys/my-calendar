...
describe('Plugin System', () => {
  ...
  describe('Plugin Registration', () => {
    ...
    it('should list all registered plugins', () => {
      ...
      const plugin2 = new Plugin({
        key: 'test2',
        state: {
          init: () => new TestPluginState({ count: 0 }),
          apply: (_tr, state) => state,
        },
      });
  ...
  describe('Plugin Dependencies', () => {
    ...
    it('should detect circular dependencies', () => {
      ...
      (
        pluginManager as unknown as { plugins: Map<string, Plugin> }
      ).plugins.set('plugin1', plugin1);
      (
        pluginManager as unknown as { plugins: Map<string, Plugin> }
      ).plugins.set('plugin2', plugin2);
  ...
  describe('Plugin Commands', () => {
    it('should execute plugin commands', () => {
      ...
      const incrementCommandFactory = commands.increment as (
        amount: number
      ) => Command;
  ...
  describe('Plugin Queries', () => {
    it('should execute plugin queries', () => {
      ...
      const mockState: CalendarState = {
        ...
        timeRange: { start: new Date(), end: new Date() },
        days: [],
        pluginStates: new Map([['test', new TestPluginState({ count: 42 })]]),
        timezone: 'UTC',
      };
